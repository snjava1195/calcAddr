...
* @returns {string}
*/
export function ed25519_sign(secret_key: string, data: string): string;
/**
...
* @returns {string}
*/
export function computeWalletAddress(workchain: number, wallet_type: WalletContractType, public_key: string): string;
/**
* @param {ClockWithOffset} clock
...
*/
export function walletPrepareTransfer(clock: ClockWithOffset, current_state: string, wallet_type: WalletContractType, public_key: string, gifts: Array<Gift>, timeout: number): UnsignedMessage | undefined;
...
export interface InitOutput {
  ...
  readonly computeWalletAddress: (a: number, b: number, c: number, d: number, e: number) => void;
  readonly walletPrepareTransfer: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number) => void;
  readonly __wbindgen_malloc: (a: number) => number;
  readonly __wbindgen_realloc: (a: number, b: number, c: number) => number;
  readonly __wbindgen_export_2: WebAssembly.Table;
  readonly _dyn_core__ops__function__FnMut__A____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h62ac14acbb413074: (a: number, b: number, c: number) => void;
  readonly __wbindgen_add_to_stack_pointer: (a: number) => number;
  readonly __wbindgen_free: (a: number, b: number) => void;
  readonly __wbindgen_exn_store: (a: number) => void;
  readonly wasm_bindgen__convert__closures__invoke2_mut__h37df926860611c10: (a: number, b: number, c: number, d: number) => void;
}
