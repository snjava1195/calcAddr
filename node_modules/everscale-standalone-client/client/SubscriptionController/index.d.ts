...
export declare class SubscriptionController {
    ...
    sendMessage(address: string, signedMessage: nt.SignedMessage): Promise<nt.Transaction>;
    subscribeToContract(address: string, params: Partial<ever.ContractUpdatesSubscription>): Promise<ever.ContractUpdatesSubscription>;
    unsubscribeFromContract(address: string): Promise<void>;
    unsubscribeFromAllContracts(): Promise<void>;
...
export declare type SendMessageCallback = {
